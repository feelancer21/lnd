...
func (x *FeeSchema) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FeeSchema) ProtoMessage() {}

func (x *FeeSchema) ProtoReflect() protoreflect.Message {
	mi := &file_lightning_proto_msgTypes[160]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FeeSchema.ProtoReflect.Descriptor instead.
func (*FeeSchema) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{160}
}

func (x *FeeSchema) GetBaseFeeMsat() int32 {
	if x != nil {
		return x.BaseFeeMsat
	}
	return 0
...
func (x *FeeSchema) GetFeeRatePpm() int32 {
	if x != nil {
		return x.FeeRatePpm
	}
	return 0
...
type PolicyUpdateRequest struct {
	...
	Inbound              *FeeSchema `protobuf:"bytes,10,opt,name=inbound,proto3" json:"inbound,omitempty"`
}
...
func (x *PolicyUpdateRequest) GetInbound() *FeeSchema {
	if x != nil {
		return x.Inbound
	}
	return nil
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x53, 0x75, 0x6d, 0x22, 0x51, 0x0a, 0x09, 0x46, 0x65, 0x65, 0x53, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x12, 0x22, 0x0a, 0x0d, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x66, 0x65, 0x65, 0x5f, 0x6d,
	...
	0x65, 0x52, 0x61, 0x74, 0x65, 0x50, 0x70, 0x6d, 0x22, 0xa2, 0x03, 0x0a, 0x13, 0x50, 0x6f, 0x6c,
	...
	0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x64, 0x12, 0x2a, 0x0a, 0x07, 0x69, 0x6e, 0x62, 0x6f,
	0x75, 0x6e, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6c, 0x6e, 0x72, 0x70,
	0x63, 0x2e, 0x46, 0x65, 0x65, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52, 0x07, 0x69, 0x6e, 0x62,
	0x6f, 0x75, 0x6e, 0x64, 0x42, 0x07, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x22, 0x8c, 0x01,
...
var file_lightning_proto_goTypes = []interface{}{
	...
	(*FeeSchema)(nil),                                           // 181: lnrpc.FeeSchema
...
var file_lightning_proto_depIdxs = []int32{
	...
	181, // 143: lnrpc.PolicyUpdateRequest.inbound:type_name -> lnrpc.FeeSchema
