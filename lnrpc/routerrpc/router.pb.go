...
type SendPaymentRequest struct {
	...
	ImputedCostRestrictions *lnrpc.ImputedCostRestriction `protobuf:"bytes,26,opt,name=imputed_cost_restrictions,json=imputedCostRestrictions,proto3" json:"imputed_cost_restrictions,omitempty"`
}
...
func (x *SendPaymentRequest) GetImputedCostRestrictions() *lnrpc.ImputedCostRestriction {
	if x != nil {
		return x.ImputedCostRestrictions
	}
	return nil
}
...
type ImportImputedCostsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The imputed cost namespaces to import. Each namespace contains its own
	// set of imputed cost policies for specific node pairs.
	Namespaces []*ImputedCostNamespace `protobuf:"bytes,1,rep,name=namespaces,proto3" json:"namespaces,omitempty"`
	// Controls the import behavior. If true, all mentioned namespaces are
	// completely replaced. If false, existing namespaces are updated and
	// non-existing namespaces are created.
	Reset_ bool `protobuf:"varint,2,opt,name=reset,proto3" json:"reset,omitempty"`
}

func (x *ImportImputedCostsRequest) Reset() {
	*x = ImportImputedCostsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ImportImputedCostsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ImportImputedCostsRequest) ProtoMessage() {}

func (x *ImportImputedCostsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_routerrpc_router_proto_msgTypes[45]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ImportImputedCostsRequest.ProtoReflect.Descriptor instead.
func (*ImportImputedCostsRequest) Descriptor() ([]byte, []int) {
	return file_routerrpc_router_proto_rawDescGZIP(), []int{45}
}

func (x *ImportImputedCostsRequest) GetNamespaces() []*ImputedCostNamespace {
	if x != nil {
		return x.Namespaces
	}
	return nil
...
func (x *ImportImputedCostsRequest) GetReset_() bool {
	if x != nil {
		return x.Reset_
	}
	return false
...
type ImportImputedCostsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ImportImputedCostsResponse) Reset() {
	*x = ImportImputedCostsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ImportImputedCostsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ImportImputedCostsResponse) ProtoMessage() {}

func (x *ImportImputedCostsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_routerrpc_router_proto_msgTypes[46]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ImportImputedCostsResponse.ProtoReflect.Descriptor instead.
func (*ImportImputedCostsResponse) Descriptor() ([]byte, []int) {
...
type ImputedCostNamespace struct {
	...
	// The namespace for the imputed cost.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// This is the default parameters applied to all node pairs that do not have
	// explicitly defined parameters.
	DefaultParameters *ImputedCostParameters `protobuf:"bytes,2,opt,name=default_parameters,json=defaultParameters,proto3" json:"default_parameters,omitempty"`
	// The imputed costs for each node pair.
	Pairs []*ImputedCostPair `protobuf:"bytes,3,rep,name=pairs,proto3" json:"pairs,omitempty"`
}

func (x *ImputedCostNamespace) Reset() {
	*x = ImputedCostNamespace{}
	if protoimpl.UnsafeEnabled {
...
func (x *ImputedCostNamespace) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ImputedCostNamespace) ProtoMessage() {}

func (x *ImputedCostNamespace) ProtoReflect() protoreflect.Message {
	mi := &file_routerrpc_router_proto_msgTypes[47]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ImputedCostNamespace.ProtoReflect.Descriptor instead.
func (*ImputedCostNamespace) Descriptor() ([]byte, []int) {
	return file_routerrpc_router_proto_rawDescGZIP(), []int{47}
}

func (x *ImputedCostNamespace) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ImputedCostNamespace) GetDefaultParameters() *ImputedCostParameters {
	if x != nil {
...
func (x *ImputedCostNamespace) GetPairs() []*ImputedCostPair {
	if x != nil {
		return x.Pairs
	}
	return nil
...
type ImputedCostPair struct {
	...
	// The destination node pubkey of the pair.
	NodeTo []byte `protobuf:"bytes,2,opt,name=node_to,json=nodeTo,proto3" json:"node_to,omitempty"`
	// The imputed cost parameters used for this pair. If not set, an existing
	// parameters is deleted and the default parameters is used.
	Parameters *ImputedCostParameters `protobuf:"bytes,3,opt,name=parameters,proto3" json:"parameters,omitempty"`
}

func (x *ImputedCostPair) Reset() {
	*x = ImputedCostPair{}
	if protoimpl.UnsafeEnabled {
...
func (x *ImputedCostPair) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ImputedCostPair) ProtoMessage() {}

func (x *ImputedCostPair) ProtoReflect() protoreflect.Message {
	mi := &file_routerrpc_router_proto_msgTypes[48]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ImputedCostPair.ProtoReflect.Descriptor instead.
func (*ImputedCostPair) Descriptor() ([]byte, []int) {
	return file_routerrpc_router_proto_rawDescGZIP(), []int{48}
}

func (x *ImputedCostPair) GetNodeFrom() []byte {
	if x != nil {
		return x.NodeFrom
	}
	return nil
...
func (x *ImputedCostPair) GetNodeTo() []byte {
	if x != nil {
		return x.NodeTo
	}
	return nil
...
func (x *ImputedCostPair) GetParameters() *ImputedCostParameters {
	if x != nil {
		return x.Parameters
	}
	return nil
...
type ImputedCostParameters struct {
	...
	// Imputed costs in parts per million (ppm) of the amount sent. These costs
	// only incur if the payment is successful. Due to pathfinding restrictions,
	// only non-negative values are currently allowed.
	CostRatePpm int32 `protobuf:"varint,1,opt,name=cost_rate_ppm,json=costRatePpm,proto3" json:"cost_rate_ppm,omitempty"`
	// Base imputed cost in millisatoshis. This cost only incurs if the payment
	// is successful. Due to pathfinding restrictions, only non-negative values
	// are currently allowed.
	CostBaseMsat int32 `protobuf:"varint,2,opt,name=cost_base_msat,json=costBaseMsat,proto3" json:"cost_base_msat,omitempty"`
	// Attempt costs in parts per million (ppm) of the amount sent. These costs
	// incur regardless of whether the payment is successful or not. Due to
	// pathfinding restrictions, only non-negative values are currently allowed.
	AttemptCostRatePpm int32 `protobuf:"varint,3,opt,name=attempt_cost_rate_ppm,json=attemptCostRatePpm,proto3" json:"attempt_cost_rate_ppm,omitempty"`
	// Base attempt cost in millisatoshis. This cost incurs regardless of
	// whether the payment is successful or not. Due to pathfinding
	// restrictions, only non-negative values are currently allowed.
	AttemptCostBaseMsat int32 `protobuf:"varint,4,opt,name=attempt_cost_base_msat,json=attemptCostBaseMsat,proto3" json:"attempt_cost_base_msat,omitempty"`
}

func (x *ImputedCostParameters) Reset() {
	*x = ImputedCostParameters{}
	if protoimpl.UnsafeEnabled {
...
func (x *ImputedCostParameters) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ImputedCostParameters) ProtoMessage() {}

func (x *ImputedCostParameters) ProtoReflect() protoreflect.Message {
	mi := &file_routerrpc_router_proto_msgTypes[49]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ImputedCostParameters.ProtoReflect.Descriptor instead.
func (*ImputedCostParameters) Descriptor() ([]byte, []int) {
	return file_routerrpc_router_proto_rawDescGZIP(), []int{49}
}

func (x *ImputedCostParameters) GetCostRatePpm() int32 {
	if x != nil {
		return x.CostRatePpm
	}
	return 0
}

func (x *ImputedCostParameters) GetCostBaseMsat() int32 {
	if x != nil {
		return x.CostBaseMsat
	}
	return 0
}

func (x *ImputedCostParameters) GetAttemptCostRatePpm() int32 {
	if x != nil {
		return x.AttemptCostRatePpm
	}
	return 0
}

func (x *ImputedCostParameters) GetAttemptCostBaseMsat() int32 {
	if x != nil {
		return x.AttemptCostBaseMsat
	}
	return 0
}

type QueryImputedCostsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The namespaces to query imputed costs for. If empty, all existing
	// namespaces will be returned.
	Namespaces []string `protobuf:"bytes,1,rep,name=namespaces,proto3" json:"namespaces,omitempty"`
}

func (x *QueryImputedCostsRequest) Reset() {
	*x = QueryImputedCostsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryImputedCostsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryImputedCostsRequest) ProtoMessage() {}

func (x *QueryImputedCostsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_routerrpc_router_proto_msgTypes[50]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryImputedCostsRequest.ProtoReflect.Descriptor instead.
func (*QueryImputedCostsRequest) Descriptor() ([]byte, []int) {
	return file_routerrpc_router_proto_rawDescGZIP(), []int{50}
}

func (x *QueryImputedCostsRequest) GetNamespaces() []string {
	if x != nil {
		return x.Namespaces
	}
	return nil
...
type QueryImputedCostsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The imputed cost namespaces with their configurations.
	Namespaces []*ImputedCostNamespace `protobuf:"bytes,1,rep,name=namespaces,proto3" json:"namespaces,omitempty"`
}

func (x *QueryImputedCostsResponse) Reset() {
	*x = QueryImputedCostsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryImputedCostsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryImputedCostsResponse) ProtoMessage() {}

func (x *QueryImputedCostsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_routerrpc_router_proto_msgTypes[51]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryImputedCostsResponse.ProtoReflect.Descriptor instead.
func (*QueryImputedCostsResponse) Descriptor() ([]byte, []int) {
	return file_routerrpc_router_proto_rawDescGZIP(), []int{51}
}

func (x *QueryImputedCostsResponse) GetNamespaces() []*ImputedCostNamespace {
	if x != nil {
		return x.Namespaces
	}
	return nil
...
type DeleteImputedCostsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The namespaces to delete. All imputed cost configurations within these
	// namespaces will be permanently removed.
	Namespaces []string `protobuf:"bytes,1,rep,name=namespaces,proto3" json:"namespaces,omitempty"`
}

func (x *DeleteImputedCostsRequest) Reset() {
	*x = DeleteImputedCostsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DeleteImputedCostsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteImputedCostsRequest) ProtoMessage() {}

func (x *DeleteImputedCostsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_routerrpc_router_proto_msgTypes[52]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteImputedCostsRequest.ProtoReflect.Descriptor instead.
func (*DeleteImputedCostsRequest) Descriptor() ([]byte, []int) {
	return file_routerrpc_router_proto_rawDescGZIP(), []int{52}
}

func (x *DeleteImputedCostsRequest) GetNamespaces() []string {
	if x != nil {
		return x.Namespaces
	}
	return nil
...
type DeleteImputedCostsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *DeleteImputedCostsResponse) Reset() {
	*x = DeleteImputedCostsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_routerrpc_router_proto_msgTypes[53]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DeleteImputedCostsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteImputedCostsResponse) ProtoMessage() {}

func (x *DeleteImputedCostsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_routerrpc_router_proto_msgTypes[53]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteImputedCostsResponse.ProtoReflect.Descriptor instead.
func (*DeleteImputedCostsResponse) Descriptor() ([]byte, []int) {
	return file_routerrpc_router_proto_rawDescGZIP(), []int{53}
}
...
var file_routerrpc_router_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xac, 0x0a, 0x0a, 0x12, 0x53, 0x65, 0x6e, 0x64, 0x50, 0x61, 0x79,
	...
	0x6d, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x12, 0x59, 0x0a, 0x19, 0x69, 0x6d, 0x70, 0x75,
	0x74, 0x65, 0x64, 0x5f, 0x63, 0x6f, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x74, 0x72, 0x69, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6c, 0x6e,
	0x72, 0x70, 0x63, 0x2e, 0x49, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x64, 0x43, 0x6f, 0x73, 0x74, 0x52,
	0x65, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x17, 0x69, 0x6d, 0x70, 0x75,
	0x74, 0x65, 0x64, 0x43, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x1a, 0x44, 0x0a, 0x16, 0x44, 0x65, 0x73, 0x74, 0x43, 0x75, 0x73, 0x74, 0x6f,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x48, 0x0a, 0x1a, 0x46, 0x69, 0x72,
	...
	0x61, 0x73, 0x6f, 0x6e, 0x22, 0xbc, 0x02, 0x0a, 0x12, 0x53, 0x65, 0x6e, 0x64, 0x54, 0x6f, 0x52,
	...
	0x65, 0x6d, 0x70, 0x45, 0x72, 0x72, 0x12, 0x71, 0x0a, 0x18, 0x66, 0x69, 0x72, 0x73, 0x74, 0x5f,
	0x68, 0x6f, 0x70, 0x5f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x72,
	0x64, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x38, 0x2e, 0x72, 0x6f, 0x75, 0x74, 0x65,
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a,
	0x02, 0x38, 0x01, 0x22, 0x5b, 0x0a, 0x13, 0x53, 0x65, 0x6e, 0x64, 0x54, 0x6f, 0x52, 0x6f, 0x75,
	0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72,
	0x65, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x70, 0x72,
	0x65, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x28, 0x0a, 0x07, 0x66, 0x61, 0x69, 0x6c, 0x75, 0x72,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x1c, 0x0a, 0x1a, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x49, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x64,
	0x43, 0x6f, 0x73, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2a, 0x81, 0x04,
	...
	0x10, 0x06, 0x2a, 0x51, 0x0a, 0x18, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x48, 0x6f, 0x6c,
	...
	0x12, 0x13, 0x0a, 0x0f, 0x52, 0x45, 0x53, 0x55, 0x4d, 0x45, 0x5f, 0x4d, 0x4f, 0x44, 0x49, 0x46,
	0x49, 0x45, 0x44, 0x10, 0x03, 0x2a, 0x35, 0x0a, 0x10, 0x43, 0x68, 0x61, 0x6e, 0x53, 0x74, 0x61,
	...
	0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x41, 0x55, 0x54, 0x4f, 0x10, 0x02, 0x32, 0x91, 0x10, 0x0a,
	...
	,
...
var file_routerrpc_router_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_routerrpc_router_proto_goTypes = []interface{}{
	...
	(*ImportImputedCostsRequest)(nil),          // 51: routerrpc.ImportImputedCostsRequest
	(*ImportImputedCostsResponse)(nil),         // 52: routerrpc.ImportImputedCostsResponse
	(*ImputedCostNamespace)(nil),               // 53: routerrpc.ImputedCostNamespace
	(*ImputedCostPair)(nil),                    // 54: routerrpc.ImputedCostPair
	(*ImputedCostParameters)(nil),              // 55: routerrpc.ImputedCostParameters
	(*QueryImputedCostsRequest)(nil),           // 56: routerrpc.QueryImputedCostsRequest
	(*QueryImputedCostsResponse)(nil),          // 57: routerrpc.QueryImputedCostsResponse
	(*DeleteImputedCostsRequest)(nil),          // 58: routerrpc.DeleteImputedCostsRequest
	(*DeleteImputedCostsResponse)(nil),         // 59: routerrpc.DeleteImputedCostsResponse
	nil,                                        // 60: routerrpc.SendPaymentRequest.DestCustomRecordsEntry
	nil,                                        // 61: routerrpc.SendPaymentRequest.FirstHopCustomRecordsEntry
	nil,                                        // 62: routerrpc.SendToRouteRequest.FirstHopCustomRecordsEntry
	nil,                                        // 63: routerrpc.BuildRouteRequest.FirstHopCustomRecordsEntry
	nil,                                        // 64: routerrpc.ForwardHtlcInterceptRequest.CustomRecordsEntry
	nil,                                        // 65: routerrpc.ForwardHtlcInterceptRequest.InWireCustomRecordsEntry
	nil,                                        // 66: routerrpc.ForwardHtlcInterceptResponse.OutWireCustomRecordsEntry
	(*lnrpc.RouteHint)(nil),                    // 67: lnrpc.RouteHint
	(lnrpc.FeatureBit)(0),                      // 68: lnrpc.FeatureBit
	(*lnrpc.ImputedCostRestriction)(nil),       // 69: lnrpc.ImputedCostRestriction
	(lnrpc.PaymentFailureReason)(0),            // 70: lnrpc.PaymentFailureReason
	(*lnrpc.Route)(nil),                        // 71: lnrpc.Route
	(*lnrpc.Failure)(nil),                      // 72: lnrpc.Failure
	(lnrpc.Failure_FailureCode)(0),             // 73: lnrpc.Failure.FailureCode
	(*lnrpc.HTLCAttempt)(nil),                  // 74: lnrpc.HTLCAttempt
	(*lnrpc.ChannelPoint)(nil),                 // 75: lnrpc.ChannelPoint
	(*lnrpc.AliasMap)(nil),                     // 76: lnrpc.AliasMap
	(*lnrpc.Payment)(nil),                      // 77: lnrpc.Payment
}
var file_routerrpc_router_proto_depIdxs = []int32{
	67, // 0: routerrpc.SendPaymentRequest.route_hints:type_name -> lnrpc.RouteHint
	60, // 1: routerrpc.SendPaymentRequest.dest_custom_records:type_name -> routerrpc.SendPaymentRequest.DestCustomRecordsEntry
	68, // 2: routerrpc.SendPaymentRequest.dest_features:type_name -> lnrpc.FeatureBit
	61, // 3: routerrpc.SendPaymentRequest.first_hop_custom_records:type_name -> routerrpc.SendPaymentRequest.FirstHopCustomRecordsEntry
	69, // 4: routerrpc.SendPaymentRequest.imputed_cost_restrictions:type_name -> lnrpc.ImputedCostRestriction
	70, // 5: routerrpc.RouteFeeResponse.failure_reason:type_name -> lnrpc.PaymentFailureReason
	71, // 6: routerrpc.SendToRouteRequest.route:type_name -> lnrpc.Route
	62, // 7: routerrpc.SendToRouteRequest.first_hop_custom_records:type_name -> routerrpc.SendToRouteRequest.FirstHopCustomRecordsEntry
	72, // 8: routerrpc.SendToRouteResponse.failure:type_name -> lnrpc.Failure
	...
	63, // 18: routerrpc.BuildRouteRequest.first_hop_custom_records:type_name -> routerrpc.BuildRouteRequest.FirstHopCustomRecordsEntry
	71, // 19: routerrpc.BuildRouteResponse.route:type_name -> lnrpc.Route
	...
	73, // 29: routerrpc.LinkFailEvent.wire_failure:type_name -> lnrpc.Failure.FailureCode
	...
	74, // 32: routerrpc.PaymentStatus.htlcs:type_name -> lnrpc.HTLCAttempt
	42, // 33: routerrpc.ForwardHtlcInterceptRequest.incoming_circuit_key:type_name -> routerrpc.CircuitKey
	64, // 34: routerrpc.ForwardHtlcInterceptRequest.custom_records:type_name -> routerrpc.ForwardHtlcInterceptRequest.CustomRecordsEntry
	65, // 35: routerrpc.ForwardHtlcInterceptRequest.in_wire_custom_records:type_name -> routerrpc.ForwardHtlcInterceptRequest.InWireCustomRecordsEntry
	...
	73, // 38: routerrpc.ForwardHtlcInterceptResponse.failure_code:type_name -> lnrpc.Failure.FailureCode
	66, // 39: routerrpc.ForwardHtlcInterceptResponse.out_wire_custom_records:type_name -> routerrpc.ForwardHtlcInterceptResponse.OutWireCustomRecordsEntry
	75, // 40: routerrpc.UpdateChanStatusRequest.chan_point:type_name -> lnrpc.ChannelPoint
	3,  // 41: routerrpc.UpdateChanStatusRequest.action:type_name -> routerrpc.ChanStatusAction
	76, // 42: routerrpc.AddAliasesRequest.alias_maps:type_name -> lnrpc.AliasMap
	76, // 43: routerrpc.AddAliasesResponse.alias_maps:type_name -> lnrpc.AliasMap
	76, // 44: routerrpc.DeleteAliasesRequest.alias_maps:type_name -> lnrpc.AliasMap
	76, // 45: routerrpc.DeleteAliasesResponse.alias_maps:type_name -> lnrpc.AliasMap
	53, // 46: routerrpc.ImportImputedCostsRequest.namespaces:type_name -> routerrpc.ImputedCostNamespace
	55, // 47: routerrpc.ImputedCostNamespace.default_parameters:type_name -> routerrpc.ImputedCostParameters
	54, // 48: routerrpc.ImputedCostNamespace.pairs:type_name -> routerrpc.ImputedCostPair
	55, // 49: routerrpc.ImputedCostPair.parameters:type_name -> routerrpc.ImputedCostParameters
	53, // 50: routerrpc.QueryImputedCostsResponse.namespaces:type_name -> routerrpc.ImputedCostNamespace
	6,  // 51: routerrpc.Router.SendPaymentV2:input_type -> routerrpc.SendPaymentRequest
	7,  // 52: routerrpc.Router.TrackPaymentV2:input_type -> routerrpc.TrackPaymentRequest
	8,  // 53: routerrpc.Router.TrackPayments:input_type -> routerrpc.TrackPaymentsRequest
	9,  // 54: routerrpc.Router.EstimateRouteFee:input_type -> routerrpc.RouteFeeRequest
	11, // 55: routerrpc.Router.SendToRoute:input_type -> routerrpc.SendToRouteRequest
	11, // 56: routerrpc.Router.SendToRouteV2:input_type -> routerrpc.SendToRouteRequest
	13, // 57: routerrpc.Router.ResetMissionControl:input_type -> routerrpc.ResetMissionControlRequest
	15, // 58: routerrpc.Router.QueryMissionControl:input_type -> routerrpc.QueryMissionControlRequest
	17, // 59: routerrpc.Router.XImportMissionControl:input_type -> routerrpc.XImportMissionControlRequest
	21, // 60: routerrpc.Router.GetMissionControlConfig:input_type -> routerrpc.GetMissionControlConfigRequest
	23, // 61: routerrpc.Router.SetMissionControlConfig:input_type -> routerrpc.SetMissionControlConfigRequest
	28, // 62: routerrpc.Router.QueryProbability:input_type -> routerrpc.QueryProbabilityRequest
	30, // 63: routerrpc.Router.BuildRoute:input_type -> routerrpc.BuildRouteRequest
	32, // 64: routerrpc.Router.SubscribeHtlcEvents:input_type -> routerrpc.SubscribeHtlcEventsRequest
	6,  // 65: routerrpc.Router.SendPayment:input_type -> routerrpc.SendPaymentRequest
	7,  // 66: routerrpc.Router.TrackPayment:input_type -> routerrpc.TrackPaymentRequest
	44, // 67: routerrpc.Router.HtlcInterceptor:input_type -> routerrpc.ForwardHtlcInterceptResponse
	45, // 68: routerrpc.Router.UpdateChanStatus:input_type -> routerrpc.UpdateChanStatusRequest
	47, // 69: routerrpc.Router.XAddLocalChanAliases:input_type -> routerrpc.AddAliasesRequest
	49, // 70: routerrpc.Router.XDeleteLocalChanAliases:input_type -> routerrpc.DeleteAliasesRequest
	51, // 71: routerrpc.Router.XImportImputedCosts:input_type -> routerrpc.ImportImputedCostsRequest
	56, // 72: routerrpc.Router.XQueryImputedCosts:input_type -> routerrpc.QueryImputedCostsRequest
	58, // 73: routerrpc.Router.XDeleteImputedCosts:input_type -> routerrpc.DeleteImputedCostsRequest
	77, // 74: routerrpc.Router.SendPaymentV2:output_type -> lnrpc.Payment
	77, // 75: routerrpc.Router.TrackPaymentV2:output_type -> lnrpc.Payment
	77, // 76: routerrpc.Router.TrackPayments:output_type -> lnrpc.Payment
	10, // 77: routerrpc.Router.EstimateRouteFee:output_type -> routerrpc.RouteFeeResponse
	12, // 78: routerrpc.Router.SendToRoute:output_type -> routerrpc.SendToRouteResponse
	74, // 79: routerrpc.Router.SendToRouteV2:output_type -> lnrpc.HTLCAttempt
	14, // 80: routerrpc.Router.ResetMissionControl:output_type -> routerrpc.ResetMissionControlResponse
	16, // 81: routerrpc.Router.QueryMissionControl:output_type -> routerrpc.QueryMissionControlResponse
	18, // 82: routerrpc.Router.XImportMissionControl:output_type -> routerrpc.XImportMissionControlResponse
	22, // 83: routerrpc.Router.GetMissionControlConfig:output_type -> routerrpc.GetMissionControlConfigResponse
	24, // 84: routerrpc.Router.SetMissionControlConfig:output_type -> routerrpc.SetMissionControlConfigResponse
	29, // 85: routerrpc.Router.QueryProbability:output_type -> routerrpc.QueryProbabilityResponse
	31, // 86: routerrpc.Router.BuildRoute:output_type -> routerrpc.BuildRouteResponse
	33, // 87: routerrpc.Router.SubscribeHtlcEvents:output_type -> routerrpc.HtlcEvent
	41, // 88: routerrpc.Router.SendPayment:output_type -> routerrpc.PaymentStatus
	41, // 89: routerrpc.Router.TrackPayment:output_type -> routerrpc.PaymentStatus
	43, // 90: routerrpc.Router.HtlcInterceptor:output_type -> routerrpc.ForwardHtlcInterceptRequest
	46, // 91: routerrpc.Router.UpdateChanStatus:output_type -> routerrpc.UpdateChanStatusResponse
	48, // 92: routerrpc.Router.XAddLocalChanAliases:output_type -> routerrpc.AddAliasesResponse
	50, // 93: routerrpc.Router.XDeleteLocalChanAliases:output_type -> routerrpc.DeleteAliasesResponse
	52, // 94: routerrpc.Router.XImportImputedCosts:output_type -> routerrpc.ImportImputedCostsResponse
	57, // 95: routerrpc.Router.XQueryImputedCosts:output_type -> routerrpc.QueryImputedCostsResponse
	59, // 96: routerrpc.Router.XDeleteImputedCosts:output_type -> routerrpc.DeleteImputedCostsResponse
...
func file_routerrpc_router_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_routerrpc_router_proto_msgTypes[45].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ImportImputedCostsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_routerrpc_router_proto_msgTypes[46].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ImportImputedCostsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_routerrpc_router_proto_msgTypes[47].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ImputedCostNamespace); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_routerrpc_router_proto_msgTypes[49].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ImputedCostParameters); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_routerrpc_router_proto_msgTypes[50].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryImputedCostsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_routerrpc_router_proto_msgTypes[51].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryImputedCostsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_routerrpc_router_proto_msgTypes[52].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeleteImputedCostsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_routerrpc_router_proto_msgTypes[53].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeleteImputedCostsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
