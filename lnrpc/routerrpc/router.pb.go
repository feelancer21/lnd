...
type SendPaymentRequest struct {
	...
	// path.
	ImputedCostRestriction *lnrpc.ImputedCostRestriction `protobuf:"bytes,26,opt,name=imputed_cost_restriction,json=imputedCostRestriction,proto3" json:"imputed_cost_restriction,omitempty"`
}
...
func (x *SendPaymentRequest) GetImputedCostRestriction() *lnrpc.ImputedCostRestriction {
	if x != nil {
		return x.ImputedCostRestriction
	}
	return nil
}
...
type ImportImputedCostsRequest struct {
	...
	// isolated set of imputed cost parameters for specific node pairs.
	// Namespaces allow for organizing different cost strategies.
	Namespaces []*ImputedCostNamespace `protobuf:"bytes,1,rep,name=namespaces,proto3" json:"namespaces,omitempty"`
	// Controls the import behavior. If true, all specified namespaces are
	// completely replaced with the provided data. If false, existing namespaces
	// are updated with new data and non-existing namespaces are created.
...
type ImputedCostNamespace struct {
	...
	// The unique identifier for this imputed cost namespace.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// The default parameters applied to all node pairs within this namespace
	// that do not have explicitly defined parameters. This provides a fallback
	// configuration for pairs not individually specified.
	...
	// The specific imputed cost configurations for individual node pairs.
...
type ImputedCostPair struct {
	...
	// The source node public key of the routing pair.
	NodeFrom []byte `protobuf:"bytes,1,opt,name=node_from,json=nodeFrom,proto3" json:"node_from,omitempty"`
	// The destination node public key of the routing pair.
	NodeTo []byte `protobuf:"bytes,2,opt,name=node_to,json=nodeTo,proto3" json:"node_to,omitempty"`
	// The imputed cost parameters to apply for this specific node pair. If not
	// set, any existing parameters for this pair are deleted and the
	// namespace's default parameters will be used instead.
...
type ImputedCostParameters struct {
	...
	// Success-based imputed cost rate in parts per million (ppm) of the amount
	// sent. These virtual costs are only applied when the payment succeeds,
	// and due to pathfinding algorithm constraints, only non-negative values
	// are currently supported.
	CostRatePpm int32 `protobuf:"varint,1,opt,name=cost_rate_ppm,json=costRatePpm,proto3" json:"cost_rate_ppm,omitempty"`
	// Success-based base imputed cost in millisatoshis. This fixed virtual cost
	// is only applied when the payment succeeds, regardless of the payment
	// amount. Due to pathfinding algorithm constraints, only non-negative
	...
	// Attempt-based imputed cost rate in parts per million (ppm) of the amount
	// sent. These virtual costs are applied for every routing attempt through
	// this node pair, regardless of whether the payment ultimately succeeds or
	// fails. Due to pathfinding algorithm constraints, only non-negative values
	// are currently supported.
	...
	// Attempt-based base imputed cost in millisatoshis. This fixed virtual cost
	// is applied for every routing attempt through this node pair, regardless
	// of the payment amount or ultimate success/failure. Due to pathfinding
	// algorithm constraints, only non-negative values are currently supported.
...
type QueryImputedCostsRequest struct {
	...
	// The specific namespaces to query imputed costs for. If this list is
	// empty, all existing namespaces and their configurations will be returned.
...
type QueryImputedCostsResponse struct {
	...
	// The requested imputed cost namespaces with their complete configurations,
	// including default parameters and individual node pair settings.
	Namespaces []*ImputedCostNamespace `protobuf:"bytes,1,rep,name=namespaces,proto3" json:"namespaces,omitempty"`
}
...
type DeleteImputedCostsRequest struct {
	...
	// The namespaces to permanently delete. All imputed cost configurations
	// within these namespaces will be immediately removed and cannot be
	// recovered. This will affect ongoing and future routing decisions.
	Namespaces []string `protobuf:"bytes,1,rep,name=namespaces,proto3" json:"namespaces,omitempty"`
}
...
var file_routerrpc_router_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xaa, 0x0a, 0x0a, 0x12, 0x53, 0x65, 0x6e, 0x64, 0x50, 0x61, 0x79,
	...
	0x6d, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x12, 0x57, 0x0a, 0x18, 0x69, 0x6d, 0x70, 0x75,
	0x74, 0x65, 0x64, 0x5f, 0x63, 0x6f, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x74, 0x72, 0x69, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6c, 0x6e, 0x72,
	0x70, 0x63, 0x2e, 0x49, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x64, 0x43, 0x6f, 0x73, 0x74, 0x52, 0x65,
	0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x16, 0x69, 0x6d, 0x70, 0x75, 0x74,
	0x65, 0x64, 0x43, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x1a, 0x44, 0x0a, 0x16, 0x44, 0x65, 0x73, 0x74, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x52,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x48, 0x0a, 0x1a, 0x46, 0x69, 0x72, 0x73, 0x74,
	...
	,
	...
	,
	...
	,
	...
	0x12, 0x08, 0x0a, 0x04, 0x41, 0x55, 0x54, 0x4f, 0x10, 0x02, 0x32, 0x91, 0x10, 0x0a, 0x06, 0x52,
	...
	,
	...
	,
...
var file_routerrpc_router_proto_depIdxs = []int32{
	...
	69, // 4: routerrpc.SendPaymentRequest.imputed_cost_restriction:type_name -> lnrpc.ImputedCostRestriction
